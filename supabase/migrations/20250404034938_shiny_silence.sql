...
-- Create the lead_todo_notes table if it doesn't exist
...
DO $$ BEGIN
  DROP POLICY IF EXISTS "Users can manage notes for their accessible todos" ON lead_todo_notes;
EXCEPTION
...
-- Add index for faster lookup by todo_id if it doesn't exist
