import React from 'react';
    import { Lead } from '../../types/crm'; // Assuming types are in this path

    // Define Customer interface needed for the dropdown
    interface Customer {
        id: string;
        name: string;
    }
          ...
          <div className="bg-white rounded-lg max-w-lg w-full p-6">
            ...
            <form onSubmit={onSubmit}>
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                {/* Change Company input to select */}
                <div>
                  ...
                  >
                    ...
                    {customers.map((customer) => (
                     ...
                     {/* Optionally add an 'Other' or allow text input if no customer matches */}
                  </select>
                </div>
                <div>
                ...
                <div>
                  ...
                  <input
                    ...
                    step="0.01"
                    value={lead.value || ''}
                    onChange={(e) => onChange({ ...lead, value: parseFloat(e.target.value) || undefined })}
                    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                  />
                </div>
              </div>
