import React from 'react';
    ...
    import { Users, Mail, UserPlus, X, Shield, Star } from 'lucide-react';
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {users.map((user) => (
                      <tr
                        key={user.id}
                        onClick={() => navigate(`/admin/users/${user.id}`)} // Make row clickable
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <select
                            value={user.role}
                            onChange={(e) => {
                              e.stopPropagation(); // Prevent row click when changing select
